<template>
  <svg
    class="h-16 w-auto max-w-full sticky top-24 text-white"
  ...
  >
    ...
    <polyline
    class="stroke-current"
    points="302.7,2.5 302.7,169.5 322.1,151.2"
    />
    <polyline
    class="stroke-current"
    points="366.4,169.5 366.4,2.5 347,20.9"
    />
    <polyline
    class="stroke-current"
    points="346,2.5 346,169.5 365.4,151.2"
    />
    <polyline
    class="stroke-current"
    points="409.7,169.5 409.7,2.5 390.4,20.9"
    />
    <polyline
    class="stroke-current"
    points="389.4,2.5 389.4,169.5 408.7,151.2"
    />
  </svg>
</template>
